...
$LNG['user_success'] = 'Användaren har skapats';
$LNG['user_exists'] = 'Detta användarnamn existerar redan';
$LNG['email_exists'] = 'Denna e-post är redan i bruk';
$LNG['all_fields'] = 'Alla fält är obligatoriska';
$LNG['user_alnum'] = 'Användarnamnet får endast bestå av bokstäver och siffror';
$LNG['user_too_short'] = 'Användarnamnet måste vara mellan 3 och 32 tecken';
$LNG['user_limit'] = 'För många konton har skapats från den här IP-adressen';
$LNG['invalid_email'] = 'Ogiltig email';
$LNG['invalid_user_pw'] = 'Ogiltigt användarnamn eller lösenord';
$LNG['invalid_captcha'] = 'Ogiltigt captcha';
